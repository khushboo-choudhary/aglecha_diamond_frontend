    ...
    <div className='CategoryPageMain'>
      ...
      <div className='CategoryBelowCategory'>
        ...
        <div className='FilterDiv'>
          <FormControl >
            <FormLabel className='checkDivs' id="demo-radio-buttons-group-label" >CATEGORIES</FormLabel>
            <RadioGroup className='checkDiv'
              aria-labelledby="demo-radio-buttons-group-label"
              defaultValue="female"
              name="radio-buttons-group"
            >
              <FormControlLabel onClick={() => navigate("/category/earings/products")} value="earings" control={<Radio />} label="Earings" />
              <FormControlLabel onClick={() => navigate("/category/bracelets/products")} value="bracelets" control={<Radio />} label="Bracelets" />
              <FormControlLabel onClick={() => navigate("/category/chains/products")} value="chains" control={<Radio />} label="Chains" />
              <FormControlLabel onClick={() => navigate("/category/rings/products")} value="rings" control={<Radio />} label="Rings" />

            </RadioGroup>


            <FormLabel className='checkDivs' id="demo-radio-buttons-group-label">PRICE</FormLabel>
            <RadioGroup className='checkDiv'
              aria-labelledby="demo-radio-buttons-group-label"
              defaultValue="female"
              name="radio-buttons-group"
            ...
            <FormLabel className='checkDivs' id="demo-radio-buttons-group-label">RATING</FormLabel>
            <RadioGroup className='checkDiv'
              aria-labelledby="demo-radio-buttons-group-label"
              defaultValue="female"
              name="radio-buttons-group"
            ...
            <FormLabel className='checkDivs' id="demo-radio-buttons-group-label">DISCOUNT RANGE</FormLabel>
            <RadioGroup className='checkDiv'
              aria-labelledby="demo-radio-buttons-group-label"
              defaultValue="female"
              name="radio-buttons-group"
