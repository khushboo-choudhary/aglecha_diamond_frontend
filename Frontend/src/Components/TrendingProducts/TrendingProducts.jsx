...
export default function TrendingProducts() {
    ...
    useEffect(() => {
        axios.get("https://diamond-ecommerce.herokuapp.com/product").then((res) => setData(res.data));
    ...
    return (
        <div className='TrendingProducts'>
            <div className='Heading'>
                <div><p>Trending Collection</p></div>
                <div className='TrendingCategory'>
                    <div onClick={() => navigate("/category/earings/products")}><p>Earings</p></div>
                    <div onClick={() => navigate("category/bracelets/products")}><p>Bracelets</p></div>
                    <div onClick={() => navigate("/category/chains/products")}><p>Chains</p></div>
                    <div onClick={() => navigate("/category/rings/products")}><p>Rings</p></div>
                </div>
            </div>
                ...
                <div className='display'>
                    {
                        data[randomId1] ? <div className='IndividualProd'
                            onClick={() => { navigate(`/${data[randomId1].tag}/${data[randomId1]._id}`);  }}
                        >
                            <div className='IndividualProdImg'>
                                <img src={data[randomId1] ? data[randomId1].image : ""} alt="" />
                            </div>
                        ...
                        : 
                            <div className='IndividualProd'><div className='LoaderSinner'><HashLoader /></div></div> 
                    } 
                ...
                <div className='display'>
                    {
                        data[randomId2] ? <div className='IndividualProd'
                            ...
                            onClick={() => { navigate(`/${data[randomId2].tag}/${data[randomId2]._id}`);  }}
                        >
                            <div className='IndividualProdImg'>
                                <img src={data[randomId2] ? data[randomId2].image : ""} alt="" />
                            </div>
                            <div className='IndividualProdTitle'>
                        ...
                        : 
                            <div className='IndividualProd'><div className='LoaderSinner'><HashLoader /></div>
                            </div> 
                     } 
                ...
                <div className='display'>

                    {
                        data[randomId3] ? <div className='IndividualProd'
                            onClick={() => { navigate(`/${data[randomId3].tag}/${data[randomId3]._id}`);  }}
                        >
                            <div className='IndividualProdImg'>
                                <img src={data[randomId3] ? data[randomId3].image : ""} alt="" />
                            </div>
                            <div className='IndividualProdTitle'>
                ...
                <div className='display'>
                    {
                        data[randomId4] ? <div className='IndividualProd'
                            onClick={() => { navigate(`/${data[randomId4].tag}/${data[randomId4]._id}`);  }}
                        >
                            <div className='IndividualProdImg'>
                                <img src={data[randomId4] ? data[randomId4].image : ""} alt="" />
                            </div>
                            <div className='IndividualProdTitle'>
