        ...
        <div className="ConatctDetailsMain">
            <div className="ConatctDetails">
                ...
                >
                    ...
                    <TextField color="secondary" focused id="outlined-basic" label="Name*" variant="outlined" onChange={(e) => setName(e.target.value)} />
                    <br />
                    <TextField
                        id="outlined-basic"
                    ...
                    <InputLabel htmlFor="standard-adornment-amount"><p className="headings">ADDRESS</p></InputLabel>
                    <TextField color="secondary" focused id="outlined-basic" label="Pin Code*" variant="outlined"
                        value={pincode}
                        onChange={(e) => {
                            const re = /^[0-9\b]+$/;
                            if (pincode.length <= 5) {
                    ...
                    />
                    <TextField id="outlined-basic" label="State*" variant="outlined" color="secondary" focused
